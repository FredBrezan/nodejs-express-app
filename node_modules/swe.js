...
function makeGetter(obj, key) { return function() { return obj[key] } }
function makeSetter(obj, key) { return function(v) { obj[key] = v } }
    ...
    for (var propName in otherObject) {
      ...
      if (propGetter || propSetter) {
        ...
        if (propType == 'function') {
          ...
          var staticVarName = '$static$' + this._className + '$' + propName;
          thisClassProto[staticVarName] = otherObject[propName];
          thisClassProto.__defineGetter__(propName, makeGetter(thisClassProto, staticVarName)); 
          thisClassProto.__defineSetter__(propName, makeSetter(thisClassProto, staticVarName));
        }
      }
    }
